 ...
 * DIRECTIONS
 *
 * Implement 'makeCountingFunction()', so that it accepts a predicate(passing in a callback) function
 ...
 */
// ------------------------------------------------------------------------------
// the following is a refactored version of the function:
// function makeCountingFunction(func) {
...
// }
// ------------------------------------------------------------------------------
// the following is a type checking version of the function:
// ------------------------------------------------------------------------------
// function makeCountingFunction(func){
//     return function (array){
//       var count = 0;
//       for (var i = 0; i < array.length; i++){
//         if(typeof func(array[i]) === 'number'){
//           addAllNumbers(array[i]);
//           count += array[i];
...
// }
// ------------------------------------------------------------------------------
// the following is the original function that was written:
// ------------------------------------------------------------------------------
...
function makeCountingFunction(func){
    return function(array){
      ...
      for(var i =0; i < array.length; i++){
        ...
        // console.log("number in the loop is: " + array[i]);
        // --------------------------------------------------
        // addAllNumbers(array[i]);
        // count += (array[i]);
      }
...
function isOdd(num) {
  ...
  //
  // below is used for refactored version of makeCountingFunction
  // ------------------------------------------------------------
  // if (num % 2 !== 0){
  //   return 1;
  //   } else {
...
function addAllNumbers(num){
  return num;
//console.log("The number in the function is : " + sum);
}
// ----------------------------------
...
// ---ADD----
// var sumOfArray = makeCountingFunction(addAllNumbers);
// var total = sumOfArray([1, 2, 3, 4, 5, 6, 7]);
// console.log('The sum of all the numbers in the array is: ' + total);
